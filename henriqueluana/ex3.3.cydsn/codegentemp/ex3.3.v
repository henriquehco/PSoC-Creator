// ======================================================================
// ex3.3.v generated from TopDesign.cysch
// 09/30/2022 at 22:27
...
module top ;
	...
	wire [0:0] tmpOE__bd_net;
	wire [0:0] tmpFB_0__bd_net;
	wire [0:0] tmpIO_0__bd_net;
	wire [0:0] tmpINTERRUPT_0__bd_net;
	electrical [0:0] tmpSIOVREF__bd_net;
	...
	cy_psoc3_pins_v1_10
		...
		bd
		 (.oe(tmpOE__bd_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__bd_net[0:0]}),
		  .io({tmpIO_0__bd_net[0:0]}),
		  .siovref(tmpSIOVREF__bd_net),
		  .interrupt({tmpINTERRUPT_0__bd_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__bd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__be_net;
	wire [0:0] tmpFB_0__be_net;
	wire [0:0] tmpIO_0__be_net;
	wire [0:0] tmpINTERRUPT_0__be_net;
	electrical [0:0] tmpSIOVREF__be_net;
	...
	cy_psoc3_pins_v1_10
		...
		be
		 (.oe(tmpOE__be_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__be_net[0:0]}),
		  .io({tmpIO_0__be_net[0:0]}),
		  .siovref(tmpSIOVREF__be_net),
		  .interrupt({tmpINTERRUPT_0__be_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__be_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
