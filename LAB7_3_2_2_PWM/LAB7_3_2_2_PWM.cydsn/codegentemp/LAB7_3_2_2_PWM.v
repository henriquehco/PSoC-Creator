// ======================================================================
// LAB7_3_2_2_PWM.v generated from TopDesign.cysch
// 10/06/2022 at 11:27
...
module top ;
	...
	wire [0:0] tmpOE__BT_net;
	wire [0:0] tmpIO_0__BT_net;
	wire [0:0] tmpINTERRUPT_0__BT_net;
	electrical [0:0] tmpSIOVREF__BT_net;
	...
	cy_psoc3_pins_v1_10
		...
		BT
		 (.oe(tmpOE__BT_net),
		  .y({1'b0}),
		  .fb({Net_13}),
		  .io({tmpIO_0__BT_net[0:0]}),
		  .siovref(tmpSIOVREF__BT_net),
		  .interrupt({tmpINTERRUPT_0__BT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("3677d515-da85-48ab-8406-4f74975cefb6"),
		  .source_clock_id(""),
		  .divisor(0),
